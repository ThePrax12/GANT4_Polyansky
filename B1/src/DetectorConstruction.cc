...
namespace B1 {
  ...
  G4VPhysicalVolume * DetectorConstruction::Construct() {
    ...
    auto solidAl1 = new G4Tubs(
      "Hole", RadiusAl, RadiusAl + 1 * mm, HalfZAl, 0. * deg, 360. * deg);

    auto logicAl1 = new G4LogicalVolume(solidAl1, // its solid
      Al_mat, // its material
      "Shape1"); // its name
    ...
    auto solidAlTop = new G4Tubs(
      "Hole", 0, RadiusAl, 0.5 * mm, 0. * deg, 360. * deg);

    auto logicAlTop = new G4LogicalVolume(solidAlTop, // its solid
      Al_mat, // its material
      "Shape1"); // its name
    ...
    auto solidAlBottom = new G4Tubs(
      "Hole", 0, RadiusAl, 0.5 * mm, 0. * deg, 360. * deg);

    auto logicAlBottom = new G4LogicalVolume(solidAlBottom, // its solid
      Al_mat, // its material
      "Shape1"); // its name
